...
/** 传统业务后端使用 Application Credential 调用的独立原文检索接口。 */
@RestController
...
public class RetrieveController {
    ...
    public RetrieveController(AuditedQueryService queryService) {
    ...
    public ResponseEntity<RetrieveResponseVO> retrieve(
            ...
            @RequestBody(required = false) RetrieveRequestDTO request
    ) {
        AuditedQueryResult<RetrieveResponseVO> result = queryService.retrieve(
